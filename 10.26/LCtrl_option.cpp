...
int LCtrl_option::Usage()
{
	...
	fprintf(stderr, "Usage:     Align [Options] <HashIndexDir> <Reads>\n\n"); 
	fprintf(stderr, "Options:   -h, --help                   help\n"); 
 	//fprintf(stderr, "           -t, --threads       <int>    thread\n"); 
	fprintf(stderr, "           -r, --ratio         <int>    candidate ratio [0.2]\n"); 
...
void LCtrl_option::show_parameters(Options* opt)
{
	...
	fprintf(stderr, "\n"); 
	fprintf(stderr, "CandidateRatio:%f\n", opt->CandidateRatio); 
