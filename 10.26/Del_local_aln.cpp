...
int Local_aln::Judge_SV(char *Seq, uint32_t ReadLength, uint32_t kmer, uint32_t GU, uint32_t GD)
{
	...
	else
	{
		...
		int maxScore = 0;
		int maxScore_pos = 0;
		// vector<Tuple> Tuple_LV;
		// // int LastP = 0;
		// // int edgeF = 0;
		// // for( int i = 0 ; i < Tuple_Vector.size() ; i++ )
		// // {
		// // 	if( Tuple_Vector[i].tuplelength >= 15 )
		// // 	{
		// // 		if( Tuple_Vector[i].read_begin > FL_Dis )
		// // 		{
		// // 			for( int k = 0 ; k < i ; k++ )
		// // 				Tuple_LV.push_back(Tuple_Vector[k]);
		// // 			break;
		// // 		}
		// // 		else
		// // 			break;
		...
		// // 	if( Tuple_Vector[i].tuplelength >= 15 )
		// // 	{
		// // 		if( Tuple_Vector[i].read_begin - edgeF > DISTANCE_SCORE )
		// // 		{
		// // 			// cout << edgeF << "\t" << Tuple_Vector[i].read_begin << endl;
		// // 			for( int k = LastP ; k < i ; k++ )
		// // 			{
		// // 				Tuple_LV.push_back(Tuple_Vector[k]);
		// // 			}
		// // 			edgeF = Tuple_Vector[i].read_begin + Tuple_Vector[i].tuplelength;
		// // 			Tuple_LV.push_back(Tuple_Vector[i]);
		// // 			LastP = i;
		// // 		}
		// // 		else
		// // 		{
		...
		// // if( ReadLength - Tuple_Vector[LastP].read_begin - Tuple_Vector[LastP].tuplelength > FL_Dis )
		// // {
		// // 	for( int k = LastP ; k < Tuple_Vector.size() ; k++ )
		// // 	{
		// // 		Tuple_LV.push_back(Tuple_Vector[k]);
		// // 	}	
		// // }
		...
		else
		{
			...
			for( int i = Track[maxScore_pos] ; i >= 0 ; i = Track[i] )
			{
				...
				flag = i;
				int link_chioce;
				link_chioce = (Tuple_Vector[i].read_begin - Tuple_Vector[Track[i]].read_begin - Tuple_Vector[Track[i]].tuplelength) - (Tuple_Vector[i].ref_begin - Tuple_Vector[Track[i]].ref_begin- Tuple_Vector[Track[i]].tuplelength);
				// cout << link_chioce << endl;
