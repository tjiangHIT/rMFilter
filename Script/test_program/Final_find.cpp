...
#define SV_RESULTS 368
#define LOW_READ 623212
#define Standard 65
...
int main()
{
	...
	filein_svresults.open("/home/tjiang/3rd_Version2/MinSize_50/chr1/chr1_sort.RSV");
	char 		temp[readLINE];
	string 		str;
	...
	ifstream Filein;
	Filein.open("/home/tjiang/3rd_Version2/MinSize_50/chr1/read_start.test");
	...
	/*ifstream filein;
	filein.open("/home/tjiang/3rd_Version2/Chr1_test_data/LowHITread_15seedsL");*/
	ofstream Judge;
	Judge.open("../Answer.test");
	ifstream Nextctrl;
	// Nextctrl.open("../local_index_results.150");
	Nextctrl.open("/home/tjiang/3rd_Version2/MinSize_50/chr1/_0001.fastq.FinalAnswer");
