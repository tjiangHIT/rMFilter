#version Python 2.7
#usage: python realdata.clipping realdata.Finalanswer realdata.originalgap
#check realdata extra_filter_percentage
#realdata.clipping come from checksam.py
#realdata.Finalanswer come from VRDT-alignment
#realdata.originalgap come from chm1-PrintGaps.py
